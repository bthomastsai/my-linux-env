...
" Modified: Thomas Tsai <bthomas.tsai@gmail.com>
"
...
"
" Change the selection color on focus change (but only if the "thomast"
" colorscheme is active).
"
if has("gui_macvim") && !exists("s:augroups_defined")
  au FocusLost * if exists("colors_name") && colors_name == "thomast" | hi Visual guibg=MacSecondarySelectedControlColor | endif
  au FocusGained * if exists("colors_name") && colors_name == "thomast" | hi Visual guibg=MacSelectedTextBackgroundColor | endif
